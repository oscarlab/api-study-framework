...
\copy (SELECT request, popularity, popularity_with_libc - popularity FROM vecsyscall_popularity_by_vote WHERE syscall = 72 and (popularity > 0.000001 or popularity_with_libc > 0.000001) ORDER BY popularity DESC, request) TO '/tmp/fcntl-popularity-by-vote.csv' WITH CSV
...
\copy (SELECT request, popularity, popularity_with_libc - popularity FROM vecsyscall_popularity_by_vote WHERE syscall = 16 and (popularity > 0.000001 or popularity_with_libc > 0.000001) ORDER BY popularity DESC, request) TO '/tmp/ioctl-popularity-by-vote.csv' WITH CSV
...
\copy (SELECT request, popularity, popularity_with_libc - popularity FROM vecsyscall_popularity_by_vote WHERE syscall = 157 and (popularity > 0.000001 or popularity_with_libc > 0.000001) ORDER BY popularity DESC, request) TO '/tmp/prctl-popularity-by-vote.csv' WITH CSV
